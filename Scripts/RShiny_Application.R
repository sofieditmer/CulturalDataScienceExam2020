...
sidebar <- dashboardSidebar(
  sidebarMenu(
    menuItem("Welcome to NLPlay", tabName = "welcome", icon = icon("child")), # Welcome Page
...
body <- dashboardBody(
  tabItems(
    ...
    tabItem(tabName = "welcome", background = "orange",
            ...
            br(),
            br(),
            h1(img(src = "NLPlayLogo2.png", height = "50%", width = "50%"), align = "center"), # Insert logo
            h4("The Danish Text-Analytical Toolbox", align = "center"),
    ...
    tabItem(tabName = "introduction",
            br(),
            br(),
            h1(strong("Welcome to"), img(src = "NLPlayLogo2.png", height = "20%", width = "20%"), align = "center"),
            br(),
            fluidRow(
